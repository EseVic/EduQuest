    ...
    <div className="mt-8 md:mt-0 relative flex items-center justify-between gap-x-8 px-10 md:px-20">
      <div className="w-full md:w-1/2 flex flex-col gap-y-2 text-center">
        ...
        <p className="mt-2 md:mt-4 text-gray-200 leading-6">
          EduQuest is designed to understand user queries deeply, allowing it to
          provide intuitive responses that address specific needs. Whether you
          are seeking information, looking for recommendations or simply
          engaging in casual conversation, EduQuest has got you covered
        </p>
      </div>
