    ...
    <div className="mt-8 relative flex flex-row-reverse gap-x-8 px-10 md:px-20 md:mb-16">
      <div className="w-full md:w-1/2 flex flex-col gap-y-2 text-center">
        ...
        <p className="mt-2 md:mt-4 text-gray-200 leading-6">
          With EduQuest, all you need to do is provide a prompt, and our advance
          AI algorithms will generate insightful and relevant responses. Our
          powerful language models ensure that you recieve intelligent and
